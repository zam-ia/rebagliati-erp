    ...
    items: [
      ...
      { path: '/inscripciones', nombre: 'Inscripciones', icon: FileEdit, permiso: 'Inscripciones' },
      {
        ...
        subItems: [
          ...
          { path: '/ventas/eventos',        nombre: 'Eventos 360', icon: Database, permiso: 'ventas_eventos' },
          { path: '/ventas/marketing',      nombre: 'Campanas y UTMs', icon: Megaphone, permiso: 'ventas_marketing' },
          { path: '/ventas/biblioteca',     nombre: 'Biblioteca', icon: FolderOpen, permiso: 'ventas_biblioteca' },
          { path: '/ventas/show',           nombre: 'Show de ventas', icon: Trophy, permiso: 'ventas_show' },
          { path: '/ventas/ranking',        nombre: 'Ranking', icon: Trophy, permiso: 'ventas_ranking' },
          { path: '/ventas/metas',          nombre: 'Metas', icon: Target, permiso: 'ventas_metas' },
          { path: '/ventas/comisiones',     nombre: 'Comisiones', icon: Gift, permiso: 'ventas_comisiones' },
          { path: '/ventas/coordinacion',   nombre: 'Coordinacion', icon: ClipboardCheck, permiso: 'ventas_coordinacion' },
          { path: '/ventas/grupos',         nombre: 'Comunidades', icon: Users, permiso: 'ventas_grupos' },
          { path: '/ventas/accesos',        nombre: 'Accesos criticos', icon: KeyRound, permiso: 'ventas_accesos' },
